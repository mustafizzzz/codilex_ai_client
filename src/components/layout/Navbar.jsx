      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-1">
            ...
            <span className="text-xl font-bold font-poppins">CodiLex.ai</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-12">
            {navLinks.map((link) => (
              <Link
                to={link.path}
                key={link.name}
                className={`text-sm transition-colors hover:text-black font-sans 
                ${
                  isActive(link.path)
          ...
          <div className="md:hidden py-4 space-y-4">
            {navLinks.map((link) => (
              <Link
                key={link.name}
                to={link.path}
                className={`block text-sm font-medium transition-colors hover:text-primary font-sans ${
