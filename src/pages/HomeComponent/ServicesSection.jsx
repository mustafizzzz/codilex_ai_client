  ...
  return (
    <section className="py-30 bg-gray-50">
      <div className="container mx-auto px-4">
        <SectionTitle subtitle="Our AI toolkit automates the tasks of research, drafting, and analysis." title="Why work harder when you can work smarter?" className="mb-12" />
